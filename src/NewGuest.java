...
public class NewGuest extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel15.add(radioButtonSilver, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 100, -1, -1));
        ...
        jPanel15.add(radioButtonPlatinum, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 100, -1, -1));
        ...
        jPanel15.add(radioButtonGold, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 100, -1, -1));
        ...
        jPanel15.add(bookNewRoom, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 620, 230, 50));
        ...
        jPanel15.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 620, 150, 50));
    ...
    void updatestatus(String RoomNo ,String Type) {
        try 
        {
...
//                com.mysql.jdbc.Connection con = (com.mysql.jdbc.Connection) DriverManager.getConnection("jdbc:mysql://localhost/rms", "root", "");
//                com.mysql.jdbc.Statement stmt = (com.mysql.jdbc.Statement) con.createStatement();
//                String query = "UPDATE gold SET status='FULL' WHERE roomno ="+ RoomNo +";";
//                stmt.executeUpdate(query);
//                JOptionPane.showMessageDialog(null, "Updated");
//            } catch (HeadlessException | ClassNotFoundException | SQLException e) {
//                JOptionPane.showMessageDialog(this, e.getMessage());
...
//        }
    ...
    private void bookNewRoomActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bookNewRoomActionPerformed
        try {
            ...
            String firstDate = a1.format(fromdate01.getDate());
            String secondDate = a1.format(todate01.getDate());
            Date fromDate = fromdate01.getDate();
            Date toDate = todate01.getDate();
    ...
    private void radioButtonGoldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_radioButtonGoldActionPerformed
        ...
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost/rms", "root", "");
            Statement stmt = con.createStatement();
            ResultSet resultSet = stmt.executeQuery("SELECT * FROM gold WHERE STATUS = 'EMPTY'");
    ...
    private void radioButtonSilverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_radioButtonSilverActionPerformed
        ...
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost/rms", "root", "");
            Statement stmt = con.createStatement();
            ResultSet resultSet = stmt.executeQuery("SELECT * FROM silver WHERE STATUS = 'EMPTY'");
            if (!resultSet.isBeforeFirst()) {
                System.out.println("No Vacant Rooms");
            }
            while (resultSet.next()) {
    ...
    private void radioButtonPlatinumActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_radioButtonPlatinumActionPerformed
        ...
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost/rms", "root", "");
            Statement stmt = con.createStatement();
            ResultSet resultSet = stmt.executeQuery("SELECT * FROM platinum WHERE STATUS = 'EMPTY'");
            if (!resultSet.isBeforeFirst()) {
                System.out.println("No Vacant Rooms");
            }
            while (resultSet.next()) {
