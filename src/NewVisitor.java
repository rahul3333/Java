...
public class NewVisitor extends javax.swing.JFrame {
    ...
    public NewVisitor(String RoomNo, int occupants, String dateCheckedIn) {
        Count = occupants;
        checkedInDate = dateCheckedIn;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (PhnNo.length() >= 10 && PhnNo.length() <= 11) {
            try {
                ...
                String query = "INSERT INTO visitor VALUES('"+Name+"','"+PhnNo+"','"+Roomno+"','"+checkedInDate+"')";
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new NewVisitor("", 0, "").setVisible(true);
            }
        });
    }
